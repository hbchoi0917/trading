...
REQUIRED_ENV_VARS = {
    ...
    "broker_auth": [
        # At least one of these groups must be set
...
def check_env_vars() -> list[tuple[bool, str, bool]]:
    ...
    # Broker auth: paper key OR OAuth (TT_SECRET + TT_REFRESH)
...
def check_timezone() -> tuple[bool, str]:
    ...
    # Warn if not Eastern time (cron schedule is ET-based)
